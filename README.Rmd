...
any set does, or if the count of specific variables has changed. I created a few functions
...
of columns equal to the value supplied to `max_depth` before giving up. If no unique keys were
...
to try and differentiate the observations. I like the STATA function 'duplicates tag' that makes it easier
to look at observations with the same IDs.

### Missing data

Missing data causes problems for statistics and programming. I have a couple of functions that
