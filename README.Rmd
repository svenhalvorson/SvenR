...
TODO:  
1. Disable the goofball `cosswalk` function. It doesn't really work for most use cases
2. Check to see if `do_nothing()` still works
3. Add example of python style rename.
